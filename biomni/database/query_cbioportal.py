"""
Camber wrapper for biomni.tool.database.query_cbioportal
"""
...
def main(prompt=None, endpoint=None, verbose=True):
    ...
    from biomni.tool.database import query_cbioportal
    """
    Wrapper for query_cbioportal from biomni.tool.database
    ...
    Examples
    --------
    - Natural language: query_cbioportal("F
    """
    result = query_cbioportal(prompt=prompt, endpoint=endpoint, verbose=verbose)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='query_cbioportal')
