#!/usr/bin/env python3
"""
Biomni Tool: Query Interpro
Wraps: biomni.tool.database.query_interpro
"""
import argparse
import sys
import subprocess
...
def main():
    ...
    output_file = os.path.join(args.output, 'interpro_results.json')
