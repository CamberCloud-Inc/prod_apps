"""
Camber wrapper for biomni.tool.database.query_ucsc
"""
...
def main(prompt=None, endpoint=None, verbose=True):
    ...
    """
    Wrapper for query_ucsc from biomni.tool.database
    ...
    Examples
    --------
    - Natural language: query_ucsc("Get DNA sequence of chrom
    """
    result = query_ucsc(prompt=prompt, endpoint=endpoint, verbose=verbose)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='query_ucsc')
