...
def main(prompt=None, endpoint=None, max_results=100, verbose=True):
    ...
    """
    result = query_openfda(prompt=prompt, endpoint=endpoint, max_results=max_results, verbose=verbose)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='query_openfda')
    parser.add_argument('--prompt', type=str, default=None, help='prompt')
    parser.add_argument('--endpoint', type=str, default=None, help='endpoint')
    parser.add_argument('--max_results', type=int, default=100, help='max_results')
